import {
  BaseFactory, WorldClock, DataParser, BaseObject,
  Armature, BuildArmaturePackage, Slot, DragonBones, SlotData,
} from 'dragonbonesjs-module'
...
export class PixiFactory extends BaseFactory {
   ...
   * @param dragonBonesName - The cached name of the DragonBonesData instance. 
   * (If not set, all DragonBonesData instances are retrieved, 
   * and when multiple DragonBonesData instances contain a the same name armature data, it may not be possible to accurately create a specific armature)
